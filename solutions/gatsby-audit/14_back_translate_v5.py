...
#!/usr/bin/env python3
"""
Step 09: Back-Translation Audit Pipeline v5
...
ORIGINAL_ESSAY = os.path.join(PIPELINE_DIR, "essay_run-20260216-100158-a5efa3.md")
ORIGINAL_SUMMARY = os.path.join(PIPELINE_DIR, "executive_summary_v4.md")
...
TRANSLATIONS = [
    {
        "language": "Spanish",
        "code": "es",
        "essay_path": os.path.join(PIPELINE_DIR, "essay_es_v5.md"),
        "summary_path": os.path.join(PIPELINE_DIR, "summary_es_v5.md"),
    },
    {
        "language": "Mandarin",
        "code": "zh",
        "essay_path": os.path.join(PIPELINE_DIR, "essay_zh_v5.md"),
        "summary_path": os.path.join(PIPELINE_DIR, "summary_zh_v5.md"),
    }
]
...
def main():
    ...
    for trans in TRANSLATIONS:
        ...
        for doc_type, trans_path, original_text in docs_to_process:
            ...
            # Save
            bt_filename = f"{doc_type}_bt_{code}_v5.md"
            ...
            # Log to Delta Lake
            log_to_delta(f"back_translations_v5/{code}", {
                "run_id": RUN_ID,
                "document": doc_type,
            ...
            log_to_delta("audit/pipeline_runs_v5", {
                "run_id": RUN_ID,
    ...
    # Final Report
    print(f"\n{'='*60}")
    print("Back-Translation Audit Report v5")
    print(f"{'='*60}")
