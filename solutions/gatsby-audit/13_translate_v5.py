...
ESSAY_PATH = "./essay_run-20260216-100158-a5efa3.md"
SUMMARY_PATH = "./executive_summary_v4.md"
OUTPUT_DIR = "."
...
def main():
    ...
    for lang_name, lang_config in LANGUAGES.items():
        ...
        for doc_name, doc_text in documents.items():
            ...
            # Save .md file
            filename = f"{doc_name}_{lang_config['code']}_v5.md"
            ...
            # Log to Delta Lake
            log_to_delta(f"translations_v5/{lang_config['code']}", {
                "run_id": RUN_ID,
                "document": doc_name,
                "language": lang_name,
